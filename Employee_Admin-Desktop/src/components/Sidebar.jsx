...
export default function Sidebar({ activePage }) {
  ...
  const employeeNavItems = [
    ...
    { name: 'Loan Inbox',         icon: Inbox,           path: '/employee/loan-inbox' },
    { name: 'Recovery',           icon: History,         path: '/employee/recovery' },
    { name: 'Auction Management', icon: Gavel,           path: '/employee/auction' },
  ];

  const adminNavItems = [
    { name: 'System Overview',    icon: BarChart3, path: '/admin/dashboard' },
    { name: 'Audit Trail',        icon: Activity,  path: '/admin/audit-trail' },
    { name: 'Auction Management', icon: Gavel,     path: '/admin/auction' },
  ];
