 ...
 *
 * Floating AI chatbot powered by the TransactFlowOS RAG service.
 * Connects via WebSocket to the RAG server, streams responses token-by-token.
 *
 * Usage: drop <ChatWidget /> anywhere in the app layout.
 */
...
const SUGGESTIONS = [
  ...
  'Tell me about my loan application.',
  'What was the result of the last auction?',
...
export default function ChatWidget() {
  ...
  const connect = useCallback(async () => {
    ...
    ws.onopen = () => {
      ws.send(JSON.stringify({ type: 'auth', token, role: 'member' }));
    };
